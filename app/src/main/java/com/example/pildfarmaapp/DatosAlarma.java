...
public class DatosAlarma {
    ...
    public DatosAlarma(String ID, String medicamento, String dosis, String frecuencia, String viaAdministracion, String duracionTratamiento, String imagen, String IDUsuario, String estado) {
        this.ID = ID;
